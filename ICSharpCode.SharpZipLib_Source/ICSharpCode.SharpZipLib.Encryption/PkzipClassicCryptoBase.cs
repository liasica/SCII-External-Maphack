namespace ICSharpCode.SharpZipLib.Encryption
{
    ...
    internal class PkzipClassicCryptoBase
    {
        ...
        protected void SetKeys(byte[] keyData)
        {
            ...
            this.keys = new uint[] { (uint)(((keyData[3] << 0x18) | (keyData[2] << 0x10)) | (keyData[1] << 8)) | keyData[0],
				(uint)(((keyData[7] << 0x18) | (keyData[6] << 0x10)) | (keyData[5] << 8)) | keyData[4],
				(uint)(((keyData[11] << 0x18) | (keyData[10] << 0x10)) | (keyData[9] << 8)) | keyData[8] };
        }
